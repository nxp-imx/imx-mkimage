...
flash_test_build_mfg flash_a0_test_build_mfg: $(MKIMG) $(SECO_FW_NAME) scfw_tcm.bin dummy_ddr.bin u-boot.bin CM4.bin kernel.bin initramfs.bin board.dtb
	./$(MKIMG) -soc DXL -rev A0 -append $(SECO_FW_NAME) -c -scfw scfw_tcm.bin -ap u-boot.bin a35 0x80000000 -m4 CM4.bin 0 0x34FE0000 -data kernel.bin 0x80280000 -data initramfs.bin 0x83100000 -data board.dtb 0x83000000 $(V2X_DUMMY_DDR) -out flash.bin

flash_scfw_test flash_a0_scfw_test: $(MKIMG) $(SECO_FW_NAME) scfw_tcm.bin scfw_tests.bin
	./$(MKIMG) -soc DXL -rev A0 -dcd skip -append $(SECO_FW_NAME) -c -scfw scfw_tcm.bin --data scfw_tests.bin 0x100000 $(V2X_DUMMY_OCRAM) -out flash.bin
