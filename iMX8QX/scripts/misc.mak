...
flash_mfg flash_b0_mfg: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin u-boot-atf.bin Image fsl-image-mfgtool-initramfs-imx_mfgtools.cpio.gz.u-boot board.dtb Image0 Image1
	./$(MKIMG) -soc QX -rev B0 -append $(AHAB_IMG) -c -scfw scfw_tcm.bin -ap u-boot-atf.bin a35 0x80000000 -data board.dtb a35 0x83000000 -data fsl-image-mfgtool-initramfs-imx_mfgtools.cpio.gz.u-boot a35 0x83100000 -data Image0 a35 0x80280000 -data Image1 a35 0x80c80000  -out flash_mfg.bin
...
flash_nand_mfg flash_nand_b0_mfg: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin u-boot-atf.bin Image fsl-image-mfgtool-initramfs-imx_mfgtools.cpio.gz.u-boot board-nand.dtb Image0 Image1
	./$(MKIMG) -soc QX -rev B0 -append $(AHAB_IMG) -c -scfw scfw_tcm.bin -ap u-boot-atf.bin a35 0x80000000 -data board-nand.dtb a35 0x83000000 -data fsl-image-mfgtool-initramfs-imx_mfgtools.cpio.gz.u-boot a35 0x83100000 -data Image0 a35 0x80280000 -data Image1 a35 0x80c80000 -out flash_mfg.bin
