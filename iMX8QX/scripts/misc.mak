...
flash_msg_block:
	./$(MKIMG) -soc QX -rev B0 -append $(AHAB_IMG) -c -scfw scfw_tcm.bin -msg_blk test_block.bin field 0x83000000 -out flash.bin

flash_flexspi_msg_block: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin u-boot-atf.bin $(QSPI_HEADER)
	./$(MKIMG) -soc QX -rev B0 -dev flexspi -append $(AHAB_IMG) -c -scfw scfw_tcm.bin -msg_blk test_block.bin field 0x83000000 -out flash.bin
