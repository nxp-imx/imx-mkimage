...
flash_m4_flexspi: $(MKIMG) $(SECO_FW_NAME) scfw_tcm.bin m4_image.bin
	./$(MKIMG) -soc DXL -rev A0 -dcd skip -dev flexspi -append $(SECO_FW_NAME) -c -scfw scfw_tcm.bin -p1 -m4 m4_image.bin 0 0x34FE0000 $(V2X_DUMMY_OCRAM) -out flash.bin
	./$(QSPI_PACKER) $(QSPI_HEADER)
