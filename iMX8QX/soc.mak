...
flash_b0: $(MKIMG) $(DCD_CFG) ahab-container.img scfw_tcm.bin dummy_ddr.bin u-boot-atf.bin
	./$(MKIMG) -soc QX -rev B0 -append ahab-container.img -c -scfw scfw_tcm.bin -ap u-boot-atf.bin a35 0x80000000 -out flash.bin

flash_b0_test_build: $(MKIMG) $(DCD_CFG) ahab-container.img scfw_tcm.bin dummy_ddr.bin u-boot.bin
	./$(MKIMG) -soc QX -rev B0 -append ahab-container.img -c -scfw scfw_tcm.bin -ap u-boot.bin a35 0x80000000 -out flash.bin
