...
flash_test_build_mfg flash_b0_test_build_mfg: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin dummy_ddr.bin u-boot.bin CM4.bin kernel.bin initramfs.bin board.dtb
	./$(MKIMG) -soc QX -rev B0 -append $(AHAB_IMG) -c -scfw scfw_tcm.bin -ap u-boot.bin a35 0x80000000 -m4 CM4.bin 0 0x34FE0000 -data kernel.bin a35 0x80280000 -data initramfs.bin a35 0x83100000 -data board.dtb a35 0x83000000 -out flash.bin

flash_scfw_test flash_b0_scfw_test: $(MKIMG) $(AHAB_IMG) scfw_tcm.bin scfw_tests.bin
	./$(MKIMG) -soc QX -rev B0 -dcd skip -append $(AHAB_IMG) -c -scfw scfw_tcm.bin --data scfw_tests.bin a35 0x100000 -out flash.bin
